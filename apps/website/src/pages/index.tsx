...
const Home: NextPage = () => {
  return (
    <>
      ...
      />
      {/* needed because of content going under the address bar on mobile */}
      <div className="absolute inset-0">
        <div className="flex flex-1 min-h-full bg-[url('/images/background.jpg')] bg-cover bg-center sm:bg-none">
